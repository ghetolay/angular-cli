...
function removeImport(sourceFile, removedIdentifiers) {
    ...
    const allNodes = ast_helpers_1.findAstNodes(null, sourceFile, ts.SyntaxKind.Identifier, true)
    ...
    identifierImports.forEach((node) => {
        ...
        if (namedImports.elements.length === 1) {
            ops.push(new make_transform_1.RemoveNodeOperation(sourceFile, node));
        }
        else {
...
//# sourceMappingURL=/home/ghetolay/git/angular-cli/src/transformers/remove_import.js.map